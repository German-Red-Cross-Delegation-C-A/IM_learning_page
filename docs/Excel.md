...
<p style="text-align: justify;">En esta sección nuestro interés como facilitadores es guiarlos en pasos simples en la limpieza básica de datos con Excel. </p>
        ...
        magina que Excel es una tabla gigante.
        ...
        ![tabla1](imagesindic/tablaex.png)

        Si ves “B5”, piensas:  
        - Letra B → columna  
        - Número 5 → fila  

        Así que buscas el punto donde la **columna B** se cruza con la **fila 5**.
        ``` 